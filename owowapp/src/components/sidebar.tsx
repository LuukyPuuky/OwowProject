...
export function Sidebar({ searchQuery, onSearchChange }: SidebarProps) {
  return (
    <aside className="w-[400px] border-r border-border bg-background flex flex-col">
      {/* Logo */}
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-6">
          <button className="w-full flex items-center justify-between text-sm font-medium mb-4 text-foreground">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-border rounded-lg p-4 space-y-2">
              <h3 className="font-medium text-foreground">Star animation</h3>
